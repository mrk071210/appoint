...
export class BasicComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.columnAttribute = [
      ...
      { name: 'sortField', type: 'string', default: 'null', description: '配置表格整体是否可以排序的属性。'},
    ...
    this.tableProperties = [
      ...
      { name: 'sortOrder', type: 'number', default: 'null', description: '默认的排序方式。（1升序、-1降序）'},
      ...
      { name: 'rowHover', type: 'boolean', default: 'false', description: '条件行hover效果。（不需要selection模式）'},
