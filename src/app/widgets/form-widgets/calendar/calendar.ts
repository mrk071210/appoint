...
import {ButtonModule} from '../../common-widgets/button/button';
import {DomHandler} from '../../commons/domhandler';
import {SharedModule,PrimeTemplate} from '../../commons/shared';
...
@Component({
    ...
    template:  `
        <span [ngClass]="{'ui-calendar':true,'ui-calendar-w-btn':showIcon}" [ngStyle]="style" [class]="styleClass">
            ...
            [style.display]="inline ? 'inline-block' : (overlayVisible ? 'block' : 'none')" [ngStyle]="datepickerStyle" (click)="onDatePickerClick($event)" [@overlayState]="inline ? 'visible' : (overlayVisible ? 'visible' : 'hidden')">
...
export class Calendar implements AfterViewInit,AfterViewChecked,OnInit,OnDestroy,ControlValueAccessor {
    ...
    ngOnInit() {
        ...
        if(this.showLanguage == "ch"){
            this._locale = this._localeChinese;
        }               
        this.createWeekDays();
