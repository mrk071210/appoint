...
import {PaginatorModule} from '../../commons/paginator/paginator';
import {Column,Header,Footer,HeaderColumnGroup,FooterColumnGroup,PrimeTemplate} from '../../commons/shared';
import {LazyLoadEvent} from '../../commons/lazyloadevent';
import {FilterMetadata} from '../../commons/filtermetadata';
import {SortMeta} from '../../commons/sortmeta';
            ...
            <tr #rowElement *ngIf="!dt.expandableRowGroups||dt.isRowGroupExpanded(rowData)"
                ...
                <ng-template ngFor let-col [ngForOf]="columns" let-colIndex="index">
                    <td #cell *ngIf="!dt.rowGroupMode || (dt.rowGroupMode == 'subheader') ||
                        ...
                        [title]="col.showDetail ? dt.resolveFieldData(rowData,col.field) : ''"
